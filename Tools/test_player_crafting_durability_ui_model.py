...
assert save_h.count("SaveVersion = 5") >= 1 and "SaveVersion = 9" in save_h  # character schema remains 5; world schema advances independently; v6 Window migration is retained
