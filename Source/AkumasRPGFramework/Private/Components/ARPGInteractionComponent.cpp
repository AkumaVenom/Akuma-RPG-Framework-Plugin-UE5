...
void UARPGInteractionComponent::ToggleBuiltWindow(AARPGBuildWindowActor* Window)
{
...
void UARPGInteractionComponent::ServerToggleBuiltWindow_Implementation(AARPGBuildWindowActor* Window)
{
